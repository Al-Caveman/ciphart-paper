...
\begin{itemize}
    ...
    hashing functions when using them is more suited, and uses encryption
    functions when encryption functions are more suited.  this is thanks to
    my ``hashing is only for compression'' law.
