...
nice, as it is a simple memory-hard key derivation function in comparison
to \emph{scrypt}\footnote{\url{http://www.tarsnap.com/scrypt/scrypt.pdf}},
...
\begin{itemize}
    ...
    \item the memory-harderness allows to require ridiculously large
...
\subsection{user scenario example}
