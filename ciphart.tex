...
\begin{itemize}
    ...
    is thanks to my ``hashing is only for compression'' law.
...
\begin{theorem}
    [perfect lie\footnote{a lie is perfect if it is indistinguishable from
    truth.}]
...
call it \emph{something random with a large entropy}.
