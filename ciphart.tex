        ...
        \For{$l=0, 1, \ldots, L-1$}{\label{ciphart_lanes}
            \For{$t=0, 1, \ldots, T-1$}{
                ...
                \For{$r=0, 1, \ldots, \hat R-1$}{
                    ...
                    $n_l \gets n_l + 1$\;
                    \uIf{$f = 0$}{
                        $v \gets m_j \bmod (gLTR + t)$\;
                        \If{$v \ge gLTR$}{
                            $v \gets v + lT$\;
                        }
                    }\Else{
                        $v \gets m_j \bmod (GLTR - LTR + t)$\;
                        \If{$v \ge gLTR$}{
                            $v \gets v + LTR$\;
                        }
                    }
...
however, i do agree that $R=1$ can be a sensible \emph{default} for most
parameter and system combinations, but this is not a reason to force $R=1$
for all other parameters or systems.
