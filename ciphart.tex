...
using screws alongside nails, except that the screws are re-invented by
modifying nails.
...
on the other hand, \emph{argon2} acts as if option 1 is better, which i
think is wrong at every level.

before i talk about how \emph{argon2} is an example of adopting the mistake
in option 1, i want to define the nails and the screws of a key derivation
function, strictly from the perspective of key derivation functions.  i.e.
ignoring unrelated aspects, such as ability to decrypt.
