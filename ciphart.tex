...
through the non-parallelise-able steps.  \emph{argon2} lacks this parameter.
...
to allows the user to set $R$ more freely.

however, i do agree that $R=1$ can be a sensible \emph{default} value when
$M$ and $T$ are large enough for a given system, but this is not a reason
to force $R=1$ for all other parameters or systems.
