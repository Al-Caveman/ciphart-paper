...
information in it.  what does this mean to us?  it means that, on average,
we'd need to ask $H(p)$ many perfect binary questions in order to fully
resolve all ambiguities about $p$; i.e.  to fully get every bit of $p$.
what is a perfect question? the that, if answered, we get the search space
reduced in half.  what is that space?  the space of hypotheses which $p$ is
an element of.

i think shannon's entropy is \emph{perfect} to quantify information in
general, but is used.

shannon's entropy means, on average, 
