...
\begin{itemize}
    ...
    you, it has the capacity to tell you that it has \emph{injected} a
    specific quantity of shannon's entropy bits into your derived key.
    this is possible thanks to my invention ``perfect lie'' theorem.
    ...
    is thanks to my ``purification'' initiative.
...
moodel of the vast majority of users.  then, memory-\emph{harder}ness
