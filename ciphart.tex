...
getting, on average, $100$ many perfect binary questions, $q_0, q_1,
\ldots, q_{99}$, answered.  we say that that's its $\log_2$-based shannon's
entropy, right?  i.e. $H(x) = 100$.

what about another thing $y$, which all ambiguities about it are resolved
after getting, on average, $10$ many questions, $\hat q_0, \hat q_1,
\ldots, \hat q_{9}$, answered, such that each question $\hat q_i$ is made
of $10$ perfect binary questions $q_{i10+0}, q_{i10+1}, \ldots, q_{i10+9}$?
...
getting, on average, $H(p)$ many perfect binary questions, $q_0, q_1,
...
p_{H(p)-1}$, and tests them by asking the following binary questions in
...
perfect binary questions, right?  i disagree.
...
containing $N$ many perfect binary questions.
